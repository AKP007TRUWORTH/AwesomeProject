...
const ParticipantStatsViewer = ({ participantId }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#2B3034" }} >
      <View
        style={{
          flexDirection: "row",
          marginVertical: 8,
      ...
      {qualityStateArray.map(({ label, audio, video }) => {
        return (
          <View style={{ paddingHorizontal: 12, flexDirection: "row", padding: 4, borderWidth: 0.5, height: 40, borderColor: colors.primary[700] }}>
            <View style={{ flex: 1 }} >
